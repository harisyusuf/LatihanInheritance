...
namespace LatihanInheritance
{
    class Program
    {
        ...
        {
            Person person = new Person("haris", 17);
            person.GetNameAndAge();

            Teacher teacher = new Teacher("Rudi Setyo", 36, "191345", "Math");
            teacher.GetNameAndAge();

            Student student = new Student("Haris Yusuf Irwanto", 17, "19.11.2727", "haris.i@students.amikom.ac.id");
